...
#image icon
Image_icon = PhotoImage(file="R.png")
...
Label(root, image=dockImage, bg="grey").place(x =30, y =25)

noteImage = PhotoImage(file="task.png")
Label(root, image=noteImage, bg="#32405b").place(x=300, y=20)

heading = Label(root, text="ALL TASK", font="Algerian", fg="white", bg="#32405b")
...
frame1 = Frame(root, bd=3, width=700, height=350, bg="grey")
